...
public class Character {
    ...
    private void setStats() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            rolls[i] = Roller.generateRoll();

            System.out.println(text.getString("roll") + " #" + (i + 1) + ": " + rolls[i]);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            do {
                ...
                try {
                    ...
                    int chosenRoll = Integer.parseInt(statReader.nextLine()); //added -1 to match array.length
                    ...
                    if (chosenRoll < 0 || chosenRoll >= 6) {
                    ...
                    } else if (rolls[chosenRoll] == 0) {  //rolls[i]
                        ...
                        switch (i) {
                            case 0:
                                strength = new Stat(stats.getString("strength"), rolls[chosenRoll]);
                                stat.add(strength);
                                break;
                            case 1:
                                dexterity = new Stat(stats.getString("dexterity"), rolls[chosenRoll]);
                                stat.add(dexterity);
                                break;
                            case 2:
                                constitution = new Stat(stats.getString("constitution"), rolls[chosenRoll]);
                                stat.add(constitution);
                                break;
                            case 3:
                                intelligence = new Stat(stats.getString("intelligence"), rolls[chosenRoll]);
                                stat.add(intelligence);
                                break;
                            case 4:
                                wisdom = new Stat(stats.getString("wisdom"), rolls[chosenRoll]);
                                stat.add(wisdom);
                                break;
                            case 5:
                                charisma = new Stat(stats.getString("charisma"), rolls[chosenRoll]);
                                stat.add(charisma);
                                break;
